...
class ScriptsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        scriptsDict.append(ScriptSctructure(did: "10155", name: "Name", scriptDescription: "Description", roomGroop0: nil))
        scriptsDict.append(ScriptSctructure(did: "10155", name: "New Name", scriptDescription: "New Description", roomGroop0: nil))
//        fetchNewScript()
    }
...
extension ScriptsViewController {
    ...
    func backViewIsDisabled() {
        UIView.animate(withDuration: 0.5, delay: 0, animations: {
            ...
            self.navigationController?.navigationBar.backgroundColor = UIColor(red: 0.867, green: 0.918, blue: 0.953, alpha: 1)
        })
    }
